...
export const Registro = () => {
  ...
  const [userPhone, setUserPhone] = useState('')
    ...
    const handleRegisterUser = (event) => {
      ...
      const usuarioUrl = 'https://crz-backend-ti-emergentes.azurewebsites.net/v1/sextob/api/usuario'
      let datosUrl = ''
      
      userType == 'Estudiante'
        ? datosUrl = 'https://crz-backend-ti-emergentes.azurewebsites.net/v1/sextob/api/estudiante'
        : datosUrl = 'https://crz-backend-ti-emergentes.azurewebsites.net/v1/sextob/api/contratista'
