...
export const Contratista = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const url = 'https://crz-backend-ti-emergentes.azurewebsites.net/v1/sextob/api/contratista'
      try {
  ...
  const handleAddRoom = () => {
    ...
    const contratistaUrl = 'https://crz-backend-ti-emergentes.azurewebsites.net/v1/sextob/api/contratista'
